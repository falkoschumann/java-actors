...
`de.muspellheim.actors.example`. It based on this [Blog][1] and include three
main classes.
...
[1]: http://geekswithblogs.net/theArchitectsNapkin/archive/2015/05/12/actors-in-a-ioda-architecture-by-example.aspx
